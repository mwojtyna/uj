...
#align(center)[
  #figure(
    ...
    table(
      ...
      [Częstotliwość wypadkowa $f_w$], 
      [1025 Hz], 
      [1030 Hz],
      
      [Częstotliwość dudnień $f_d$], 
      [50 Hz], 
      [50.05 Hz],
    ),
